...
function BusinessViewPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<BusinessInterface>(
    ...
    () =>
      getBusinessById(id, {
        relations: ['user', 'message', 'team_member'],
      }),
  );
  ...
  const team_memberHandleCreate = async () => {
    setCreateError(null);
    try {
      await createTeamMember({ business_id: id, user_id: team_memberUserId });
              ...
              {hasAccess('message', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/messages/create?business_id=${data?.id}`}>
